...
mongoose.connect(mongoUrl, { useNewUrlParser: true,autoIndex:true, useCreateIndex: true } ).then(
...
app.get("/account", passportConfig.isAuthorized, userController.getAccount);
